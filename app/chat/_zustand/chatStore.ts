...
import { ChatMessage, ChatRoom, ChatRoomState } from '../_types/chat';
import { getMyRooms } from '../_api/chat';
...
interface ChatStoreState {
  ...
  // Actions
  connectSocket: (user: UserDetail) => void; // 채팅 소켓 연결
...
const useChatStore = create<ChatStoreState>((set, get) => ({
  ...
  // 채팅 소켓 연결
  connectSocket: async (user: UserDetail) => {
